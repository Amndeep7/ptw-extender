...
const handleAniList = async (tab, urlData, options) => {
  ...
  const oldnotes = data.Media.mediaListEntry && data.Media.mediaListEntry.notes ? data.Media.mediaListEntry.notes : '';
  // eslint-disable-next-line no-undef
  ...
  const oldCustomLists =
    data.Media.mediaListEntry && data.Media.mediaListEntry.customLists ? data.Media.mediaListEntry.customLists : {};

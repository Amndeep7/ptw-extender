    ...
    if (document.querySelector('#myanimelist')) {
      ...
      if (status.value === '1') {
        ...
        switch (message.type) {
          ...
          case 'manga':
            if (
              haventstarted.includes(document.querySelector('#add_manga_num_read_volumes').value) &&
      ...
      const title = document.querySelector('#main-form > table > tbody > tr').children[1].textContent.trim();
